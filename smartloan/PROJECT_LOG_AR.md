...
> آخر تحديث: 12 أغسطس 2026 (تأكيد رفع المتجر + التركيز على جلسات Smart Loan فقط).
>
...
- **الويب:** PWA على `smartappsflow.net/smartloan/` (يُنشر تلقائيًا عند الدمج إلى `main`) — **مباشر حاليًا (v40)**.
