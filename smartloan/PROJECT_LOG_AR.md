...
> آخر تحديث: 25 يوليو 2026 (بعد دمج الويب + تأكيد الـ APK على الجهاز).
>
...
- **المتجر:** Android AAB يُبنى عبر `.github/workflows/build-smartloan.yml` (يدوي: workflow_dispatch).
  المحاذاة والثيمات **مؤكَّدة على الجهاز**؛ رفع Play مؤجَّل لجلسات لاحقة.
...
### حالة المرحلة الحالية (25 يوليو 2026)
...
| رفع هذه النسخة إلى Play | ⏳ لاحقًا (الـ APK جاهز للبناء) |
| ميزات مدفوعة / Billing | ⏸ مؤجَّل |

**الفرع الذي حمل هذا المعلم:** `fix/smartloan-safearea-and-tweaks` → دُمج إلى `main`
(`51a3d72`). العمل التالي يكون على **فرع جديد**، لا تُعد فتح العمل على ذلك الفرع
إلا للرجوع التاريخي.
...
### الجلسات القادمة (المتجر والمنتج — ليس عاجلًا للويب)
- [ ] **رفع versionCode** قبل كل رفعة للمتجر (31 → 32 …) و`versionName` في `build-smartloan.yml`.
- [ ] **رفع AAB إلى Play Console** عندما تقرر الرفعة (البناء: workflow_dispatch على الفرع المناسب).
